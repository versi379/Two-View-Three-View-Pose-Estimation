...
%%%%%%%%% TITLE
\title{Template for Technical Reports \\ IACV Project} 

\author{Luca Magri\\
Politecnico di Milano\\
{\tt\small luca.magri@polimi.it}
...
Vincenzo Caglioti\\
Politecnico di Milano\\
{\tt\small vincenzo.caglioti@polimi.it}
}
...
%%%%%%%%% ABSTRACT
\begin{abstract}
   The ABSTRACT should be self contained and explain what the report is about. Usually abstracts are no longer than 300 words. You should state what are the main contributions of your work and tempt the reader to continue to read your paper. A good abstract briefly describes your problem, approach, and key results. This document is based on the CVPR submission template, and it has been adapted to submit a technical report of a project of the Image Analysis and Computer Vision course. This report is based on the guidelines provided for the course of Deep Learning and Image Classification by Giacomo Boracchi and Matteo Matteucci.
...
Papers, excluding the references section, must be about \textbf{6} pages, but must be no longer than \textbf{six pages}. The maximum number of pages is strict. Overlength papers will simply not be graded or graded negatively. Note that this \LaTeX\ guide already sets figure captions and references in a smaller font.
